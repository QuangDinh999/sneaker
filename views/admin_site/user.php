    ...
    <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
        ...
        <div id="toolbar" class="btn-group">
            <a href="index.php?controller=user&action=create" class="btn btn-primary">
                <i class="fa-solid fa-list"></i> Add User
            </a>
        </div>
        <div class="row">
            <div class="col-lg-12">
                <div class="panel panel-default">
                    <div class="panel-body">
                        <table data-toolbar="#toolbar" class="table" data-toggle="table">
                            ...
                            <tbody>
                            <?php
                                foreach ($array['user'] as $us){
                            ?>
                            <tr>
                                <td style=""><?=$us['user_id']?></td>
                                <td style=""><?=$us['user_name']?></td>
                                <td style=""><?=$us['email']?></td>
                                <td class="form-group">
                                    <a href="index.php?controller=user&action=edit&id=<?=$us['user_id']?>" class="btn btn-success"><i class="fa-regular fa-square-plus"></i></a>
                                    <a href="index.php?controller=user&action=destroy&id=<?=$us['user_id']?> " onclick="alert('Xóa user thành công')" class="btn btn-danger"><i class="fa-solid fa-trash-can"></i></a>
                                </td>
                            </tr>
                            <?php
                                }
                    ...
                    <div class="panel-footer" style="text-align: center">
                        ...
                        for($i = 1; $i < $array['page']; $i++){
                            ?>
                            <form style="display: inline-block" method="post" action="index.php?controller=user">
