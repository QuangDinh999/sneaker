                    ...
                    <div class="panel-body">
                        <div class="col-md-8">
                            ...
                            foreach ($brand as $bra){
                                ?>
                                <form role="form" method="post" action="index.php?controller=brand&action=update">
                                    <input type="hidden" name="brand_id" value="<?=$bra['brand_id']?>">
                                    <div class="form-group">
                                        <label>Name Brand</label>
                                        <input required type="text" name="brand_name" value="<?=$bra['brand_name']?>"  class="form-control" placeholder="Name..." style="border: 1px solid #2c64c4">
                                    </div>
                                    <button type="submit" name="sbm" class="btn btn-success" onclick="alert('Cập nhật Nhãn hàng thành công')">Cập Nhật</button>
                                </form>
                                <?php
                            }
                            ?>
