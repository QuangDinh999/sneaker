                            ...
                            <?php
                                foreach ($array['category'] as $cat){
                                    ...
                                    <tr>
                                        ...
                                        <td class="form-group">
                                            <a href="index.php?controller=category&action=edit&id=<?=$cat['category_id']?>" class="btn btn-success"><i class="fa-regular fa-square-plus"></i></a>
                                            <a href="index.php?controller=category&action=destroy&id=<?=$cat['category_id']?>" onclick="alert('Xóa Category thành công')" class="btn btn-danger"><i class="fa-solid fa-trash-can"></i></a>
                                        </td>
                                    </tr>
                            <?php
                                }
