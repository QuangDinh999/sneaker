...
<!--                            <div class="alert alert-danger">Danh mục đã tồn tại !</div>-->
                            <form role="form" method="post" action="index.php?controller=category&action=store">
                                <div class="form-group">
                                    ...
                                    <input required type="text" name="category_name" class="form-control" placeholder="Name..." style="border: 1px solid #2c64c4">
                                </div>
                                <button type="submit" name="sbm" class="btn btn-success" onclick="alert('Thêm Category thành công')">Thêm mới</button>
                            </form>
                        </div>
                    </div>
                </div>
