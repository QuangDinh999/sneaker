    ...
    <nav class="navbar navbar-light navbar-fixed-top" style="background-color: rgb(33, 84, 84);" role="navigation">
        <div class="container-fluid">
            <div class="navbar-header ">
                ...
                <ul class="user-menu">
                    <li>
                        <a href="index.php?controller=admin&action=logout" style="font-size: large"><i class="fa-solid fa-right-to-bracket"></i>  Log Out</span></a>
                    </li>
                </ul>
            </div>
        </div><!-- /.container-fluid -->
    ...
    <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
        ...
        <div id="toolbar" class="btn-group">
            <a href="index.php?controller=brand&action=create" class="btn btn-primary">
                <i class="fa-solid fa-list"></i> Add brand
            </a>
        </div>
        <div class="row">
            <div class="col-md-12">
                        ...
                        <table data-toolbar="#toolbar" class="table" data-toggle="table">
                            ...
                            ?>
                                    <tr>
                                        ...
                                        <td class="form-group">
                                            <a href="index.php?controller=brand&action=edit&id=<?=$bra['brand_id']?>" class="btn btn-success"><i class="fa-regular fa-square-plus"></i></a>
                                            <a href="index.php?controller=brand&action=destroy&id=<?=$bra['brand_id']?>" onclick="alert('Xóa Nhãn hàng thành công')" class="btn btn-danger"><i class="fa-solid fa-trash-can"></i></a>
                                        </td>
                                    </tr>
                            <?php
                                }
