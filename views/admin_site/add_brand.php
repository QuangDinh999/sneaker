                ...
                <div class="panel panel-default">
                    <div class="panel-body">
                        <div class="col-md-8">
                            ...
                            <form role="form" method="post" action="index.php?controller=brand&action=store">
                                <div class="form-group">
                                    <label>Name Brand</label>
                                    <input required type="text" name="brand_name" class="form-control" placeholder="Brand..." style="border: 1px solid #2c64c4">
                                </div>
                                <button type="submit" name="sbm" class="btn btn-success" onclick="alert('Thêm Nhãn hàng thành công')">Thêm mới</button>
                            </form>
                        </div>
                    </div>
                </div>
