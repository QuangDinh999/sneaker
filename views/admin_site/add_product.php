            ...
            <div class="col-lg-12">
                <div class="panel panel-default">
                    <div class="panel-body">
                        <form role="form" method="post" enctype="multipart/form-data" action="index.php?controller=product&action=store">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>Sản phẩm</label>
                                    <input type="text" name="shoes_name" required class="form-control" value=""  placeholder="" style="border: 1px solid #2c64c4">
                                </div>

                                <div class="form-group">
                                    <label>Giá</label>
                                    <input type="number" name="price" min="0" required value="" class="form-control" style="border: 1px solid #2c64c4">
                                </div>
                                <div class="form-group">
                                    <label>Size</label>
                                    <input type="number" name="size"  min="36" " required value="" class="form-control" style="border: 1px solid #2c64c4">
                                </div>
                                <div class="form-group">
                                    <label>Màu</label>
                                    <input type="text" name="color" required value="" class="form-control" style="border: 1px solid #2c64c4">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>Ảnh sản phẩm</label>
                                    <input type="file" name="image" required onchange="preview()">
                                    <br>
                                    <div>
                                        <img src="views/img/Shoes/dowload.jpeg" id="image" width ="295px" height = "325px">
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="description" required class="form-control" rows="3" style="border: 1px solid #2c64c4"></textarea>
                                </div>
                                <button type="submit" name="sbm" class="btn btn-success" onclick="alert('Thêm sản phẩm thành công')">Thêm mới</button>
                            </div>
                        </form>
                    </div>
                </div>
