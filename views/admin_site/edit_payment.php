    ...
    <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
        ...
        <div class="row">
            <div class="col-lg-12" style="text-align: center;">
                <h1 class="page-header">Edit Payment methods</h1>
            </div>
        </div><!--/.row-->
                    ...
                    <div class="panel-body">
                        <div class="col-md-8">
                            ...
                            foreach ($payment as $pay){
                                ?>
                                <form role="form" method="post" action="index.php?controller=payment&action=update">
                                    <input type="hidden" name="payment_id" value="<?=$pay['payment_id']?>">
                                    <div class="form-group">
                                        <label>Name category</label>
                                        <input required type="text" name="payment_name" value="<?=$pay['payment_name']?>"  class="form-control" placeholder="Name..." style="border: 1px solid #2c64c4">
                                    </div>
                                    <button type="submit" name="sbm" class="btn btn-success" onclick="alert('Cập nhật PTTT thành công')">Cập Nhật</button>
                                </form>
                                <?php
                            }
                            ?>
